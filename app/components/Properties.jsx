                    ...
                    <main className='mt-[52px] flex-wrap justify-center md:flex-nowrap  md:flex-row flex gap-6'>
                        ...
                        <div className='flex flex-col gap-[24px]'>
                            ...
                            <div className='relative  group overflow-hidden'>
                                <Image src="/R01.png" width={500} height={300} alt="Image" className='md:w-full w-[600px] bg-black bg-opacity-0 hover:bg-opacity-30 md:h-auto h-[250px] transition-transform duration-500 group-hover:scale-110' />
                            ...
                            <div className='relative group overflow-hidden'>
                                <Image src="/R02.png" width={500} height={300} alt="Image" className='md:w-full w-[600px] bg-black bg-opacity-0 hover:bg-opacity-30  md:h-auto h-[230px] transition-transform duration-500 group-hover:scale-110' />
                                <div className='absolute bottom-0 left-0 right-0 p-4'>
